...
RSpec.describe ElectionsController, :type => :controller do
  ...
  # ElectionsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested election as @election" do
      election = Election.create! valid_attributes
      get :show, {:id => election.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested election as @election" do
      election = Election.create! valid_attributes
      get :edit, {:id => election.to_param}, valid_session
      expect(assigns(:election)).to eq(election)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Election" do
        expect {
          post :create, {:election => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved election as @election" do
        post :create, {:election => invalid_attributes}, valid_session
        expect(assigns(:election)).to be_a_new(Election)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested election" do
        election = Election.create! valid_attributes
        put :update, {:id => election.to_param, :election => new_attributes}, valid_session
        election.reload
      ...
      it "assigns the requested election as @election" do
        election = Election.create! valid_attributes
        put :update, {:id => election.to_param, :election => valid_attributes}, valid_session
        expect(assigns(:election)).to eq(election)
      end
    ...
    describe "with invalid params" do
      it "assigns the election as @election" do
        election = Election.create! valid_attributes
        put :update, {:id => election.to_param, :election => invalid_attributes}, valid_session
        expect(assigns(:election)).to eq(election)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested election" do
      election = Election.create! valid_attributes
      expect {
        delete :destroy, {:id => election.to_param}, valid_session
      }.to change(Election, :count).by(-1)
    end
